import math
import time
from flcore.clients.clientscar2 import clientScar2
...
class FedScar2(Server):
    ...
    def train(self):
        for epoch in tqdm(range(1, self.global_rounds + 1), desc='server-training'):
            ...
            global_para += self.beta * torch.mean(self.dual_vec_list, dim=0)
